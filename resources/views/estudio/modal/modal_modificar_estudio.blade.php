    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-5" style="display: inline-flex;">
                                    ...
                                    <input type="text" id="est_cod_update" name="est_cod_update" class="form-control form-control-sm est_cod_update" autocomplete="off" style="text-transform: uppercase; border-radius: 0px 5px 5px 0px;" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-sm-12" >
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="est_nombre_update" name="est_nombre_update" class="form-control form-control-sm est_nombre_update" autocomplete="off" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase(); " required>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control form-control-sm est_descripcion_update" name="est_descripcion_update" id="est_descripcion_update" cols="35" rows="2" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase(); "></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm est_grupos_update" id="est_grupos_update" name="est_grupos_update" required>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm est_subgrupos_update" id="est_subgrupos_update" name="est_subgrupos_update">
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm est_muestra_update" id="est_muestra_update" name="est_muestra_update" required>
                                        <option value="" selected="" disabled>SELECCIONAR...</option>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm est_recipiente_update" id="est_recipiente_update" name="est_recipiente_update">
                                        <option value="" selected="">SELECCIONAR...</option>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm est_indicaciones_update" id="est_indicaciones_update" name="est_indicaciones_update">
                                        <option value="" selected="">SELECCIONAR...</option>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="number" min="0" step="0.01" id="est_precio_update" name="est_precio_update" class="form-control form-control-sm est_precio_update" autocomplete="off" required>
                                </div>
                                <div class="col-md-3">
            ...
            <div class="modal-footer">
                <button id="btnEditEstudio" class="btn btn-warning btnEditEstudio">Actualizar</button>
            </div>
        </div>
    </div>
</div>