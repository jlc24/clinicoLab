<div class="modal fade" id="modal_configurar_estudio_individual" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="modal_configurar_estudio_individualLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #7EE2F0; color: #000">
                <h1 class="modal-title fs-5" id="modal_configurar_estudio_individualLabel"><strong class="estudioTitulo"></strong></h1>
                ...
                <div class="row justify-content-center datos_componentes" style="display: none;">
                    <div class="col-xl-12 col-sm-12 pt-1" style="background-color: #7EE2F0;">
                        <label class="col-md-12 col-form-label">
                            <a href="#" data-toggle="modal" data-target="#modal_crear_componente" class=" btn-add-comp" title="Agregar componente">
                                <i class="fas fa-plus-circle fa-lg"></i>
                            </a>{{ __('Componentes') }}:
                        </label>
