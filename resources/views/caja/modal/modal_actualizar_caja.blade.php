<div class="modal fade" id="modal_actualizar_caja_{{ $caja->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="modal_actualizar_caja_{{ $caja->id }}Label" aria-hidden="true">
    <div class="modal-dialog mdoal-md">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #32C861; color: #fff">
                <h1 class="modal-title fs-5" id="modal_actualizar_caja_{{ $caja->id }}Label"><strong>{{ __('Cerrar Caja') }}</strong></h1>
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('cajas/'.$caja->id) }}" method="POST" class="form-horizontal" id="formulario_cerrar_caja">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label" for="caja_cambio">{{ __('Cambio') }}:</label>
                                <div class="col-md-8" style="display: inline-flex">
                                    <input type="hidden" value="0" name="caja_estado" id="caja_estado">
                                    <input type="number" step="0.01" value="{{ $caja->caja_monto_inicial }}" id="caja_cambio" name="caja_cambio" class="form-control form-control-sm" autocomplete="off" style="text-transform: uppercase; border-radius: 5px 0px 0px 5px;" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                                    <div class="input-group-prepend" >
                                        <div class="input-group-text" style=" border-radius: 0px 5px 5px 0px; height: 31px;"><i class="fas fa-dollar-sign"></i></div>
                                    </div>
                                </div>
