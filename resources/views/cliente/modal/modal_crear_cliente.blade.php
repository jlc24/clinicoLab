                        ...
                        <div class="col-xl-3 col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    {{-- <small><span style="color: red;" id="error_cli_celular">(Se requiere Nº C.I.)</span></small> --}}
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Correo electrónico" class="form-control form-control-sm" id="cli_email" name="cli_email" autocomplete="off">
